...
public class GameScreen extends ScreenAdapter {
    ...
    int mScore;
    int mHighScore;
    Preferences mPrefs; //←追加

    Sound sound = Gdx.audio.newSound(Gdx.files.internal("Dead1SE.mp3"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mEnemies = new ArrayList<Enemy>(); //敵キャラ量産化
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            Step step = new Step(type, stepTexture, 0, 0, 180, 36);
